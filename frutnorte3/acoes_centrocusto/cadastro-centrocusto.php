...
if (isset($_GET['id']) && !empty($_GET['id'])) {
    $isEdicao = true;
    $centrocusto_id = $_GET['id'];
    
    try {
        // Buscar dados do centro de custo, verificando se pertence à empresa logada
        $sql = "SELECT * FROM centrocusto WHERE id = ? AND idcliente = ?";
        $stmt = $conn->prepare($sql);
        $stmt->execute([$centrocusto_id, $idcliente_empresa]);
        $centrocusto = $stmt->fetch(PDO::FETCH_ASSOC);
        ...
        $_SESSION['msg'] = "Erro ao carregar dados do centro de custo: " . $e->getMessage();
        $_SESSION['msg_type'] = "error";
        header("Location: ../centrocusto.php");
        exit;
    }
    ...
    <div class="content-wrapper">
        ...
        <div class="page-header">
            <div class="breadcrumb">
                ...
                <span class="breadcrumb-separator">/</span>
                <span class="breadcrumb-item active">Cadastro de Centro de Custo</span>
            </div>
            <h1 class="page-title">
                ...
                <div class="title-content">
                    <span class="title-main">Cadastro de Centro de Custo</span>
                    <p class="title-subtitle">Configure centros de custo para organização financeira</p>
                </div>
            </h1>
        </div>
        ...
        <div class="form-container">
            <form id="centroCustoForm" class="expense-form">
                    ...
                    <div class="form-grid">
                        <div class="form-group1">
                            ...
                            <div class="input-wrapper">
                                <input type="text" id="codigo" name="codigo" class="form-input" readonly placeholder="Será gerado automaticamente">
                        ...
                        <div class="form-group form-group-wide">
                            ...
                            <div class="input-wrapper">
                                <input type="text" id="descricao" name="descricao" class="form-input" maxlength="255" required>
                        ...
                        <div class="form-group">
                            ...
                            <div class="switch-wrapper">
                                <label class="switch">
                                    <input type="checkbox" id="ativo" name="ativo" value="S" checked>
                                    <span class="slider round"></span>
                                </label>
                                <span class="switch-status" id="ativo-status">Ativo</span>
                            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    async function handleFormSubmit(e) {
        ...
        await salvarCentroCusto(formData);
    }
    ...
    function collectFormData() {
        ...
        const allInputs = document.querySelectorAll('#centroCustoForm input, #centroCustoForm select');
    ...
    async function salvarCentroCusto(formData) {
        const submitBtn = form.querySelector('button[type="submit"]');
        submitBtn.classList.add('loading');
        submitBtn.disabled = true;
        
        try {
            const response = await fetch('../api_centrocusto/salvar_centrocusto.php', {
                method: 'POST',
                headers: {
            ...
            if (result.success) {
                showToast(`Centro de custo cadastrado com sucesso! Código: ${result.centrocusto.codigo} - Redirecionando em 2 segundos...`);
                
                setTimeout(() => {
                    window.location.href = '../centrocusto.php';
                }, 2000);
                
            } else {
                showToast(result.message || 'Erro ao cadastrar centro de custo', 'error');
            }
        } catch (error) {
