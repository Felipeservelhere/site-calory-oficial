                                ...
                                <table class="table">
                                    ...
                                    <?php
                                        ...
                                        if (isset($_REQUEST['f'])) {
                                            switch ($_REQUEST['f']) {
                                                case '1':
                                                    $ComandosSQL_5555BackupAtraso = $ComandosSQL_BackupAtraso." and prioridadeBackup=1 ".$Orderby; 
                                                    break;
                                                case '2':
                                                    $ComandosSQL_5555BackupAtraso = $ComandosSQL_BackupAtraso." and prioridadeBackup=2 ".$Orderby; 
                                                    break;
                                                case '3':
                                                    $ComandosSQL_5555BackupAtraso = $ComandosSQL_BackupAtraso." and prioridadeBackup=3 ".$Orderby; 
                                                    break;
                                                case '4':
                                                    $ComandosSQL_5555BackupAtraso = $ComandosSQL_BackupAtraso." and prioridadeBackup=4 ".$Orderby; 
                                                    break;
                                                default:
                                                    $ComandosSQL_5555BackupAtraso = $ComandosSQL_BackupAtraso.$Orderby; 
                                                    break;
                                            }
                                        }   
                                          
                                        $sqlTable = mysqli_query($mysqli, $comandoSQL_ProtocoloFechados);
                                       ...
                                       ?>      
                                             ...
                                             <td style="text-align: center;"><?php echo $linha['RESPONSAVEL']; ?></td>
                                             <td  style="text-align: center;"><?php                                              
                                                                echo date('d/m/Y', strtotime($linha['data']));                                      
                                             ?></td>
                                             <td style="text-align: center;"><?php echo $linha['qtd']; ?></td>
