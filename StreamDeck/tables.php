...
<body class="padTop53 " >
 ...
 <li class="panel active">
                        <a href="index.php" >
                            <i class="icon-table"></i> Dashboard</a>                   
                    </li>
                    <li><a href="tables.php"><i class="icon-warning-sign"></i> Backups Atrasados </a></li>
                    <li><a href="tables2.php"><i class="icon-warning-sign"></i> Protocolos / Fechados </a></li>
                    <li class="panel ">
                ...
                <li class="panel active"><a href="tables.php"><i class="icon-table"></i> Data Tables </a></li>
        ...
        <div id="content">
            ...
            <div class="row">
                 <div class="col-lg-12">
                    ...
                    <a href="?f=1" class="btn btn-danger btn-line" for="b1"> Urgente</a>                      
                    <a href="?f=2" class="btn btn-warning btn-line">Alto</a>
                    <a href="?f=3" class="btn btn-success btn-line">Baixo</a>
                    <a href="?f=4" class="btn btn-info btn-line">Normal</a>
                    <a href="?f=5" class="btn btn-default btn-line">Nuvem3</a>
                       </div>
                            <div class="table-responsive">                               
                                <table class="table">
                                    ...
                                    <tbody>
                                    <?php
                                        $Orderby = " order by prioridadeBackup asc,diasatraso desc ";
                                        if (isset($_REQUEST['f'])) {
                                            switch ($_REQUEST['f']) {
                                                case '1':
                                                    $ComandosSQL_BackupAtraso = $ComandosSQL_BackupAtraso." and localbd=0 and prioridadeBackup=1 ".$Orderby; 
                                                    break;
                                                case '2':
                                                    $ComandosSQL_BackupAtraso = $ComandosSQL_BackupAtraso." and localbd=0 and prioridadeBackup=2 ".$Orderby; 
                                                    break;
                                                case '3':
                                                    $ComandosSQL_BackupAtraso = $ComandosSQL_BackupAtraso." and localbd=0 and prioridadeBackup=3 ".$Orderby; 
                                                    break;
                                                case '4':
                                                    $ComandosSQL_BackupAtraso = $ComandosSQL_BackupAtraso."  and localbd=0 and prioridadeBackup=4 ".$Orderby; 
                                                    break;
                                                case '5':
                                                    $ComandosSQL_BackupAtraso = $ComandosSQL_BackupAtraso." and localbd=3 ".$Orderby; 
                                                    break;
                                                default:
                                                    $ComandosSQL_BackupAtraso.$Orderby; 
                                                    break;
                                            }
                                        }   
                                          
                                        $sqlTable = mysqli_query($mysqli, $ComandosSQL_BackupAtraso);
                                       ...
                                       ?>      
                                             ...
                                             <td style="text-align: center;"><?php echo $linha['Aplicacao']; ?></td>
                                             <td style="text-align: center;"><?php echo $linha['nome']; ?></td>
                                             <td  style="text-align: center;"><?php                                              
                                                                echo date('d/m/Y', strtotime($linha['ultimo_bkp']));                                      
                                             ?></td>
                                             <td  style="text-align: center;"><?php echo $linha['prioridadeBackup']; ?></td>
                                             <td  style="text-align: center;"><?php echo $linha['DiasAtraso']; ?></td>
                                             </tr> 
                                        <?php        
                                        }?>
